  ...
  const hendalRegister = async (e: { preventDefault: () => void; }) => {
    try {
      ...
      if (resultAction.payload && resultAction.payload.username) {
        ...
        console.log("Registered user:", resultAction.payload); localStorage.setItem("loggedInUser", JSON.stringify(resultAction.payload.username));
    ...
    <div className='register-main'>
     ...
     <form onSubmit={hendalRegister}>
      {errorMessage && <p className="error">{errorMessage}</p>  }
        ...
        <input type="text" name="phoneNumber" value={newUser.phoneNumber} onChange={handleInputChange} />
